...
<head>
  ...
  <title>Online Concession Card</title>
        ...
        <div class="collapse navbar-collapse" id="navigation-nav">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a class="section-scroll" href="#wrapper">Home</a></li>
					<li><a href="admin1.php/applicationview1.php">Application View</a></li>
          <li><a href="admin1.php/listofapprovestudent.php">Approved List</a></li>
          <li><a href="admin1.php/listofdeclinestudent.php">Declined List</a></li>
					<li><a href="admin1.php/feedbackview.php">Feedback View</a></li>
