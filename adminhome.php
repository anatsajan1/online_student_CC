      ...
      <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="navigation-nav">
          <ul class="nav navbar-nav navbar-right">
					<li><a href="admin/applicationview.php">Application View</a></li>
         
          <li><a href="admin/listofdeclinestudent.php">Declined Student</a></li>
					<li><a href="admin/feedbackview.php">Feedback View</a></li>
